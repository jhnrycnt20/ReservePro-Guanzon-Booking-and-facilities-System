            ...
            <div class="rp-card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="starts_at" id="startsAt" class="form-control" value="{{ $startsAt }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="endsAt">Ends (optional)</label>
                        <input type="datetime-local" name="ends_at" id="endsAt" class="form-control" value="{{ $endsAt }}">
                    </div>
                    <div class="col-md-6">
